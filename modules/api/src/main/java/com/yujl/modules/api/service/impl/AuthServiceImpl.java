package com.yujl.modules.api.service.impl;

import com.google.gson.Gson;
import com.wf.captcha.SpecCaptcha;
import com.wf.captcha.base.Captcha;
import com.yujl.common.utils.EncryptUtil;
...
import com.yujl.modules.api.repository.RefreshTokenDao;
import com.yujl.modules.api.repository.SettingsDao;
import com.yujl.modules.api.response.ResponseResult;
import com.yujl.modules.api.service.AuthService;
import com.yujl.modules.api.utils.*;
...
public class AuthServiceImpl implements AuthService {
    ...
    **/
    ...
    public ResponseResult updateUserPassword(String verifyCode, User user) {
        ...
        redisUtils.del(Constans.User.KEY_EMAIL_CONTENT + email);
        String encrypt = EncryptUtil.encrypt(user.getPassword(), user.getSalt());
