package com.yujl.modules.api.response;
...
public class ResponseResult {
    ...
    public static ResponseResult RGESGIR_SUCCESS(){
        return new ResponseResult(ResponseState.RGESGIR_SUCCESS);
    }
    public static ResponseResult AUCCOUNT_NOT_LOGIN(){
        return new ResponseResult(ResponseState.AUCCOUNT_NOT_LOGIN);
    }

    public static ResponseResult AUCCOUNT_UNAUTHORIZED(){
        return new ResponseResult(ResponseState.AUCCOUNT_UNAUTHORIZED);
    }
    ...
    public static ResponseResult AUCCOUNT_DENIED(){
        return new ResponseResult(ResponseState.AUCCOUNT_DENIED);
    }
