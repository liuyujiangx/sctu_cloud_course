...
public class EmailSender {
    ...
    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_163(false), "a13281814207@163.com", "ULIPSXXLRUUFOVFA");
    }
    ...
    public static void sendRegisterVerifyCode(String code, String email) throws MessagingException {
        EmailSender.subject("YUJL博客系统验证码")
                .from("YUJL博客系统")
                .text("您的验证码是：" + code)
                .to(email)
                .send();
